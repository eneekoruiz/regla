...
export const LOCAL_CHAT_TOPICS: readonly LocalTopic[] = [
  ...
  { id: 'bleeding', label: 'Sangrado y manchado', prompt: 'Sangrado y manchado menstrual',
    pattern: /sangrad|manchad|spotting|flujo|hemorrag|irregular|marr[oó]n|raro/i,
    text: 'Entiendo que ver un sangrado irregular o un flujo de color diferente (como marrón) pueda asustar, pero intenta estar tranquila. Muchas veces el moco marrón es simplemente sangre antigua que ha tardado más en salir, y los pequeños desajustes son comunes por estrés o cambios hormonales leves. Anótalo en tu diario para llevar el control. Eso sí, ten en cuenta que no puedo hacer un diagnóstico médico; si el sangrado es muy abundante, va acompañado de dolor fuerte, o notas un cambio muy drástico que no cesa, lo más seguro es acudir a un profesional médico por precaución.', source: 'periods' },
