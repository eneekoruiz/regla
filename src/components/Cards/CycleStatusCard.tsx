...
export function CycleStatusCard() {
  ...
  return <section className="min-w-0 space-y-4 text-[var(--text-primary)]">
    <div className="flex flex-wrap items-center justify-between gap-2">
      ...
      <span className="text-sm text-[var(--text-secondary)]" role="status">{currentDayInfo.symptoms.length === 1 ? '1 síntoma' : `${currentDayInfo.symptoms.length} síntomas`}</span>
    </div>
