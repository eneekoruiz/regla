...
export function DailyLogBottomSheet({
  ...
  const handleSaveAndClose = () => {
    try {
      if (bleedingChoice === 'period') {
        ...
        toast.success(isCycleStart ? 'Inicio de ciclo y registro guardado' : 'Regla registrada');
        ...
        toast.success('Sangrado irregular guardado');
      } else {
        if (existingBleeding) {
  ...
  return (
    <ModalFrame
      ...
      description={`Un pequeño momento para escucharte · ${dateFormatted}`}
      footer={
